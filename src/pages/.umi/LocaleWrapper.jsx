...
const localeInfo = {
  'en-US': {
    messages: {
      ...require('/media/taha/70E48D47E48D1090/Paid Projects/Blockchain/upwork/File storage using azure and ethereum/safe-vault/src/locales/en-US.js').default,
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...require('/media/taha/70E48D47E48D1090/Paid Projects/Blockchain/upwork/File storage using azure and ethereum/safe-vault/src/locales/pt-BR.js').default,
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...require('/media/taha/70E48D47E48D1090/Paid Projects/Blockchain/upwork/File storage using azure and ethereum/safe-vault/src/locales/zh-CN.js').default,
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...require('/media/taha/70E48D47E48D1090/Paid Projects/Blockchain/upwork/File storage using azure and ethereum/safe-vault/src/locales/zh-TW.js').default,
    },
    locale: 'zh-TW',
