...
export async function firebaseRegister(params) {
  try {
    return await firebaseAuth.auth().createUserWithEmailAndPassword(params.mail, params.password);
  } catch (e) {
    return e;
  }
}
...
export async function firebaseSignIn(params) {
  try {
    return await firebaseAuth.auth().signInWithEmailAndPassword(params.userName, params.password);
  } catch (e) {
    return e;
  }
}
